...
class ResNet(nn.Module):
    def __init__(self, block, layers, stride=None):
        ...
        self.layer1 = self._make_layer(block, 64, layers[0], stride=stride[0])      # 64 256 256
        self.layer2 = self._make_layer(block, 128, layers[1], stride=stride[1])     # 256 128 512
        self.layer3 = self._make_layer(block, 256, layers[2], stride=stride[2])     # 512 256 1024
        self.layer4 = self._make_layer(block, 512, layers[3], stride=stride[3])     # 1024 512 2048
